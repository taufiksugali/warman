...
<head>
    ...
    <link href="<?= base_url(); ?>/theme/dist/assets/css/pages/login/login-4.css" rel="stylesheet" type="text/css" />
        ...
        <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div
                ...
                <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                    <!--begin::Logo-->
                    <a class="login-logo pb-xl-5 pb-15" style="margin-left: 150px">
                        <img src="<?= base_url(); ?>/logo/logo_poslog.png" class="max-h-100px" alt="" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Signin-->
                    <div class="login-form">
                        ...
                        <!--begin::Form-->
                        <form class="form" id="kt_login_singin_form" action="<?= base_url('auth/login'); ?>"
                            method="post">
                            <!--begin::Title-->
                            ...
                            <!--end::Form group-->
                            <!--begin::Action-->
                            <div class="d-flex justify-content-between pb-lg-0 pb-5">
                                <a href="<?= base_url(''); ?>" class="btn btn-text-dark-50 btn-icon-primary btn-hover-icon-danger font-weight-bold btn-hover-bg-light px-8 py-4 my-3">
            ...
            <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
                <div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom"
                    style="background-image: url(<?= base_url(); ?>/theme/dist/assets/media/bg/ikon_web_stori-01.png); background-color: #3F7EB3;">
                    <!--begin::Aside title-->
                    <h3 class="pt-lg-10 pl-lg-20 pb-lg-0 pl-10 py-20 m-0 d-flex justify-content-lg-start font-weight-boldest display5 display1-lg text-white">
