        ...
        <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div
                ...
                <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                    <!--begin::Logo-->
                    <a href="#" class="login-logo pb-xl-5 pb-15" style="margin-left: 150px">
                        <img src="<?= base_url(); ?>/logo/stori-2.jpg" class="max-h-100px" alt="" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Signin-->
                    <div class="login-form">
                        ...
                        <!--begin::Form-->
                        <form class="form" id="kt_login_singin_form" action="<?= base_url('auth/forgot'); ?>"
                            method="post">
                            <div class="pb-5 pb-lg-15">
                                <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Forgotten Password
                                    ?</h3>
                                <p class="text-muted font-weight-bold font-size-h4">Enter your email to reset your Email</p>
                            </div>
                            <!--end::Title-->
                            <!--begin::Form group-->
                            ...
                            <div class="form-group d-flex flex-wrap">
                                ...
                                <a href="<?= base_url('/'); ?>" id="kt_login_forgot_cancel"
            ...
            <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
                <div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom"
                    ...
                    <!--begin::Aside title-->
                    <h3
                        class="pt-lg-10 pl-lg-20 pb-lg-0 pl-10 py-20 m-0 d-flex justify-content-lg-start font-weight-boldest display5 display1-lg text-white">
