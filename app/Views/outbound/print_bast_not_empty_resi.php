        ...
        <div class="row">
          <div class="col-5 border border-dark">
            ...
            <table width=100%>
              ...
              <tr>
                <td align='center'>
                <?php echo date_format(date_create($data_outbound->create_date), "D, d F Y H:i") ?><br/><b><?php echo $data_outbound->transporter_marketplace ?></b>
                </td>
              </tr>
              <tr>
                <td align='center'>
              ...
              <tr>
                <td align='center'>
                  <img style="width:250px" alt='Barcode' 
                    src="<?= base_url('/barcode.php?codetype=code128&size=40&text='.@$data_outbound->po_resi_number.'&print=true') ?>">
                </td>
              </tr>
            </table>
          </div>
