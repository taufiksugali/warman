		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Add Menu</a>
                    </li>
                </ul>
				<!--end::Page Title-->
			</div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form method="post" class="form" action="<?php echo base_url('menu/create'); ?>">
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Menu Name
                                    <span class="text-danger">*</span></label>
                                    <input type="text" name="menu_name" class="form-control <?= ($validation->getError('menu_name')) ? 'is-invalid' : ''; ?>" placeholder="Enter name" />
                                    <?php if($validation->getError('menu_name')){ echo '<div class="invalid-feedback">'.$validation->getError('menu_name').'</div>'; } ?>
                                </div>
                                <div class="form-group">
                                    <label>Icon
                                    <span class="text-danger">*</span></label>
                                    <input type="text" name="icon" class="form-control <?= ($validation->getError('icon')) ? 'is-invalid' : ''; ?>" placeholder="Enter icon name" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio-inline">
                                        <label class="radio">
                                        <input type="radio" checked name="is_parent" value="1">
                                        <span></span>Yes</label>
                                        <label class="radio radio-danger">
                                        <input type="radio" name="is_parent" value="0">
                                        <span></span>No</label>
                                    </div>
