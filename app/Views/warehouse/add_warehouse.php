		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Add Warehouse</a>
                    </li>
                </ul>
				<!--end::Page Title-->
			</div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form method="post" class="form" action="<?php echo base_url('warehouse/create'); ?>">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="warehouse_code" class="form-control <?= ($validation->getError('warehouse_code')) ? 'is-invalid' : ''; ?>" placeholder="Enter code" />
                                            <?php if($validation->getError('warehouse_code')){ echo '<div class="invalid-feedback">'.$validation->getError('warehouse_code').'</div>'; } ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Warehouse Name
                                            <span class="text-danger">*</span></label>
                                            <input type="text" name="warehouse_name" class="form-control <?= ($validation->getError('warehouse_name')) ? 'is-invalid' : ''; ?>" placeholder="Enter name" />
                                            <?php if($validation->getError('warehouse_name')){ echo '<div class="invalid-feedback">'.$validation->getError('warehouse_name').'</div>'; } ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Warehouse Province (Provinsi)
                                            <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label>Warehouse District (Kecamatan)
                                            <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label>Warehouse Sub District (Kelurahan)
                                            <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger">*</span></label>
                                            <textarea name="warehouse_address" class="form-control <?= ($validation->getError('warehouse_address')) ? 'is-invalid' : ''; ?>" placeholder="Enter address"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio-inline">
                                                <label class="radio">
                                                <input type="radio" checked name="wh_metode" value="0">
                                                <span></span>FIFO</label>
                                                <label class="radio radio-danger">
                                                <input type="radio" name="wh_metode" value="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio-inline">
                                                <label class="radio">
                                                <input type="radio"  name="wh_dropship" value="1">
                                                <span></span>Yes</label>
                                                <label class="radio radio-danger">
                                                <input type="radio" checked name="wh_dropship" value="0">
                                                <span></span>No</label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio-inline">
                                                <label class="radio">
                                                <input type="radio" name="wh_cop" value="1">
                                                <span></span>Yes</label>
                                                <label class="radio radio-danger">
                                                <input type="radio" checked name="wh_cop" value="0">
                                                <span></span>No</label>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio-inline">
                                                <label class="radio">
                                                <input type="radio" checked name="is_open" value="1">
                                        ...
                                        <div class="form-group">
                                            <label>Opening Hour
                                            <span class="text-danger">*</span></label>
                                            <input class="form-control" id="kt_timepicker_1" name="opening_hour" value="<?php echo date_format(date_create(date('Y-m-d H:i:s')), 'H:i'); ?>" readonly="readonly" placeholder="Select time" type="text">
                                            <span class="form-text text-muted">Determine this warehouse opening hour</span>
                                        </div>
                                        <div class="form-group">
                                            <label>Closing Hour
                                            <span class="text-danger">*</span></label>
                                            <input class="form-control" id="kt_timepicker_1" name="closing_hour" value="<?php echo date_format(date_create(date('Y-m-d H:i:s')), 'H:i'); ?>" readonly="readonly" placeholder="Select time" type="text">
