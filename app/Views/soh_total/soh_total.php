			...
			<div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Manual Update Stock</a>
                    </li>
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Manual Update Stock Data</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
			</div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Manual Update Stock Data
...
<!--end::Content-->
<!-- modal detail shelf -->
<div class="modal fade" id="sohtotal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="sohtotal" aria-hidden="true">
...
<script>
    function get_soh_total(idx) {
				var sot_id = document.getElementById('sohtotal'+idx+'').value;
				console.log(sot_id);

				// AJAX request
				$.ajax({
					url: 'soh_total/get_soh_byId',
					type: 'post',
					data: {sot_id: sot_id},
