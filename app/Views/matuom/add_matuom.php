	...
	<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-2">
				<!--begin::Page Title-->
				<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Material Uom</h5>
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Material Uom</a>
                    </li>
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Add Material Uom</a>
                    </li>
                </ul>
				<!--end::Page Title-->
			</div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Add Material Uom</h3>
                        </div>
                        <!--begin::Form-->
                        <form method="post" class="form" action="<?php echo base_url('materialuom/create'); ?>">
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <select class="select form-control custom-select showproduct <?= ($validation->getError('material_id')) ? 'is-invalid' : ''; ?>" value="<?= old('material_id'); ?>" id="material_id" name="material_id">
                                            ...
                                            foreach ($material as $row) :
                                                ?>
                                            <option value="<?= $row->material_id ?>"><?= $row->material_id.' - '. $row->material_name . ' 1 '. $row->uom_name?></option>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="<?= old('qty'); ?>" id="qty" name="qty" 
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?= base_url('materialuom'); ?>" class="btn btn-secondary"  type="reset" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
