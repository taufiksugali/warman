                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Add Pallet</h3>
                        </div>
                        <!--begin::Form-->
                        <form method="post" class="form" action="<?php echo base_url('rak/create'); ?>">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select select2 <?= ($validation->getError('blok_id')) ? 'is-invalid' : ''; ?>" value="<?= old('blok_id'); ?>" id="blok_id_master" name="blok_id">
                                        <option value="" selected></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rak_code" class="form-control <?= ($validation->getError('rak_code')) ? 'is-invalid' : ''; ?>" placeholder="Enter code" />
                                    <?php if($validation->getError('rak_code')){ echo '<div class="invalid-feedback">'.$validation->getError('rak_code').'</div>'; } ?>
                                </div>
                                <div class="form-group">
                                    <label>Pallet Name
                                    <span class="text-danger">*</span></label>
                                    <input type="text" name="rak_name" class="form-control <?= ($validation->getError('rak_name')) ? 'is-invalid' : ''; ?>" placeholder="Enter name" />
