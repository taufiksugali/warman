<?php use App\Models\BlokModel; ?>
<?php use App\Models\RakModel; ?>
<?php use App\Models\ShelfModel; ?>
<?php $this->blok = new BlokModel(); ?>
<?php $this->rak = new RakModel(); ?>
<?php $this->shelf = new ShelfModel(); ?>
<!--begin::Content-->
	...
	<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-2">
				<!--begin::Page Title-->
				<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Move Location</h5>
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Location</a>
                    </li>
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Move Location</a>
                    </li>
                </ul>
				<!--end::Page Title-->
			</div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form method="post" class="form" action="<?php echo base_url('location/update'); ?>" onsubmit="return validate_form()">
                            <div class="card-body">
                                <div class="input_fields_loc">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" value="<?= $detail_material->location_id ?>" name="location_id" class="form-control" />
                                            <input type="hidden" value="<?= $detail_material->shelf_id ?>" name="shelf_from" class="form-control" />
                                            <input type="hidden" value="<?= $detail_material->qty ?>" name="shelf_qty" class="form-control" />
                                            <input type="hidden" value="<?= $detail_material->shelf_availability ?>" name="shelf_from_avail" class="form-control" />
                                    ...
                                    <div class="form-group row">
                                        <div class="col-6">
                                            ...
                                            <span class="text-danger">*</span></label>
                                            <input type="text" value="<?= $detail_material->qty ?>" id="qty_good" name="qty" readonly class="form-control form-control-solid <?= ($validation->getError('supplier_id')) ? 'is-invalid' : ''; ?>" placeholder="Enter code" />
                                                ...
                                                <div>
                                                    <div class="form-group row">
                                                        <div class="col-6">
                                                            ...
                                                            <select class="select form-control custom-select showproduct <?= ($validation->getError('material_id')) ? 'is-invalid' : ''; ?>" value="<?= old('area_id'); ?>" id="area_id0" name="area_id[0]" onchange="get_blok()">
                                                                ...
                                                                ?>
                                                                <option value="<?= $row->area_id ?>" <?php if($row->area_id == $detail_material->wh_area_id){ echo 'selected'; } ?>><?= $row->wh_area_name ?></option>
                                                        ...
                                                        <div class="col-5">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <option></option>
                                                                <option value="<?= @$detail_material->blok_id ?>" selected ><?= @$this->blok->get_blok_byid($detail_material->blok_id)->blok_name ?></option>
                                                            </select>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-6">
                                                            ...
                                                            <select class="select form-control custom-select showproduct <?= ($validation->getError('material_id')) ? 'is-invalid' : ''; ?>" value="<?= old('material_id'); ?>" id="rak_id0" name="rak_id[0]" onchange="get_shelf()">
                                                                <option></option>
                                                                <option value="<?= @$detail_material->rak_id ?>" selected ><?= @$this->rak->get_rak_byid($detail_material->rak_id)->rak_name ?></option>
                                                            </select>
                                                        ...
                                                        <div class="col-5">
                                                            ...
                                                            <div class="input-group">
                                                                <select class="select form-control custom-select showproduct <?= ($validation->getError('material_id')) ? 'is-invalid' : ''; ?>" value="<?= old('material_id'); ?>" id="shelf_id0" name="shelf_id[0]" onchange="get_avail()">
                                                                    <option></option>
                                                                    <option value="<?= @$detail_material->shelf_id ?>" selected ><?= @$this->shelf->get_shelf_byid($detail_material->shelf_id)->shelf_name ?></option>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-6">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" readonly value="<?= $detail_material->shelf_availability ?>" class="form-control form-control-solid <?= ($validation->getError('quantity')) ? 'is-invalid' : ''; ?>" id="sisa_kosong0" name="sisa_kosong[0]" placeholder="Shelf Availability">
                                                                <?php if($validation->getError('quantity')){ echo '<div class="invalid-feedback">'.$validation->getError('quantity').'</div>'; } ?>
                                                            </div>
                                                        </div>
                                                        <div class="col-5">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control numbers <?= ($validation->getError('quantity')) ? 'is-invalid' : ''; ?>" value="<?= $detail_material->qty ?>" id="quantity0" name="quantity[0]" placeholder="Quantity">
                                                                <?php if($validation->getError('quantity')){ echo '<div class="invalid-feedback">'.$validation->getError('quantity').'</div>'; } ?>
                                                            </div>
                                                        </div>
                                                        <div class="col-1">
