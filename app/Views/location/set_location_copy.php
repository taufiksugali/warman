                            ...
                            <div class="card-body">
                                <div class="input_fields_loc">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div id="po_ng" class="add_location_ng">
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label class="font-weight-bold">Area<span class="text-danger">*</span></label>
                                                            <select class="select form-control custom-select showproduct <?= ($validation->getError('material_id')) ? 'is-invalid' : ''; ?>" value="<?= old('area_id_ng'); ?>" id="area_id_ng0" name="area_id_ng[0]" onchange="get_blok()">
                                                                <option></option>
                                                                <?php if (@$warehouse_area) :
                                                                    foreach ($warehouse_area as $row) :
                                                                ?>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="font-weight-bold">Block<span class="text-danger">*</span></label>
                                                            <div class="input-group">
                                                                <select class="select form-control custom-select showproduct <?= ($validation->getError('blok_id_ng')) ? 'is-invalid' : ''; ?>" value="<?= old('blok_id_ng'); ?>" id="blok_id_ng0" name="blok_id_ng[0]" onchange="get_rak()">
                                                                <option></option>
                                                                
                                                            </select>
                                                                <?php if($validation->getError('blok_id_ng')){ echo '<div class="invalid-feedback">'.$validation->getError('blok_id_ng').'</div>'; } ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="font-weight-bold">Rack<span class="text-danger">*</span></label>
                                                            <select class="select form-control custom-select showproduct <?= ($validation->getError('rak_id_ng')) ? 'is-invalid' : ''; ?>" value="<?= old('rak_id_ng'); ?>" id="rak_id_ng0" name="rak_id_ng[0]" onchange="get_shelf()">
                                                                <option></option>
                                                                
                                                            </select>
                                                            <?php if($validation->getError('rak_id_ng')){ echo '<div class="invalid-feedback">'.$validation->getError('rak_id_ng').'</div>'; } ?>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="font-weight-bold">Shelf<span class="text-danger">*</span></label>
                                                            <div class="input-group">
                                                                <select class="select form-control custom-select showproduct <?= ($validation->getError('shelf_id_ng')) ? 'is-invalid' : ''; ?>" value="<?= old('shelf_id_ng'); ?>" id="shelf_id_ng0" name="shelf_id_ng[0]" onchange="get_avail()">
                                                                    <option></option>
                                                                    
                                                                </select>
                                                                <?php if($validation->getError('shelf_id_ng')){ echo '<div class="invalid-feedback">'.$validation->getError('shelf_id_ng').'</div>'; } ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-5">
