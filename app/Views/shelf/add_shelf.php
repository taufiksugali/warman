            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form method="post" class="form" action="<?php echo base_url('shelf/create'); ?>">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label class="font-weight-bold">Pallet Name<span class="text-danger">*</span></label>
                                    <select class="form-control select select2 <?= ($validation->getError('rak_id')) ? 'is-invalid' : ''; ?>" value="<?= old('rak_id'); ?>" id="rak_id_master" name="rak_id">
                                        <option value="" selected></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="shelf_code" class="form-control <?= ($validation->getError('shelf_code')) ? 'is-invalid' : ''; ?>" placeholder="Enter code" />
                                    <?php if($validation->getError('shelf_code')){ echo '<div class="invalid-feedback">'.$validation->getError('shelf_code').'</div>'; } ?>
                                </div>
                                <div class="form-group">
                                    <label>Level Name
                                    <span class="text-danger">*</span></label>
                                    <input type="text" name="shelf_name" class="form-control <?= ($validation->getError('shelf_name')) ? 'is-invalid' : ''; ?>" placeholder="Enter name" />
                                    <?php if($validation->getError('shelf_name')){ echo '<div class="invalid-feedback">'.$validation->getError('shelf_name').'</div>'; } ?>
                                </div>
                                <div class="form-group">
                                    <label>Level Max Capacity
                                    <span class="text-danger">*</span></label>
                                    <input type="text" name="shelf_max" class="form-control <?= ($validation->getError('shelf_max')) ? 'is-invalid' : ''; ?>" placeholder="Enter name" />
